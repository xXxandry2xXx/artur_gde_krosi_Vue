...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        computed: {
            currentSelectedFilters(): Object {
                return store.state.selectedFilters;
            },
        ...
        methods: {
            handleMinPrice(this: any, event: Event) {
                ...
                store.state.selectedFilters.priceMin = Number(target.value);
            },
            ...
            handleMaxPrice(this: any, event: Event) {
                ...
                store.state.selectedFilters.priceMax = Number(target.value);
            },
